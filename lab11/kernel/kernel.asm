...
0000000080000000 <_entry>:
    ...
    80000016:	744060ef          	jal	ra,8000675a <start>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    8000034c:	f10080e7          	jalr	-240(ra) # 80007258 <lockfree_read4>
    ...
    8000036c:	8de080e7          	jalr	-1826(ra) # 80006c46 <printf>
  ...
  scheduler();        
    ...
    80000434:	22a080e7          	jalr	554(ra) # 8000665a <pci_init>
    sockinit();
    80000438:	00006097          	auipc	ra,0x6
    8000043c:	e18080e7          	jalr	-488(ra) # 80006250 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004ae:	752080e7          	jalr	1874(ra) # 80006bfc <panic>
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
  ...
  a = PGROUNDDOWN(va);
    ...
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    800005d2:	62e080e7          	jalr	1582(ra) # 80006bfc <panic>
      return -1;
...
00000000800005f2 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000061e:	5e2080e7          	jalr	1506(ra) # 80006bfc <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008bc:	344080e7          	jalr	836(ra) # 80006bfc <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009fe:	202080e7          	jalr	514(ra) # 80006bfc <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b54:	0ac080e7          	jalr	172(ra) # 80006bfc <panic>
...
wakeup1(struct proc *p)
{
  ...
  if(!holding(&p->lock))
    ...
    80000d34:	39c080e7          	jalr	924(ra) # 800070cc <holding>
  ...
  if(p->chan == p && p->state == SLEEPING) {
    ...
    80000d56:	eaa080e7          	jalr	-342(ra) # 80006bfc <panic>
  if(p->chan == p && p->state == SLEEPING) {
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dfa:	e06080e7          	jalr	-506(ra) # 80006bfc <panic>
...
0000000080000dfe <procinit>:
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000e26:	294080e7          	jalr	660(ra) # 800070b6 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e5c:	25e080e7          	jalr	606(ra) # 800070b6 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000ed0:	22e080e7          	jalr	558(ra) # 800070fa <push_off>
  ...
  pop_off();
    ...
    80000eea:	2b4080e7          	jalr	692(ra) # 8000719a <pop_off>
}
...
0000000080000efa <forkret>:
{
  ...
  release(&myproc()->lock);
    ...
    80000f0e:	2f0080e7          	jalr	752(ra) # 800071fa <release>
  if (first) {
    80000f12:	00009797          	auipc	a5,0x9
    80000f16:	96e7a783          	lw	a5,-1682(a5) # 80009880 <first.1720>
  ...
  usertrapret();
    ...
    80000f30:	9407aa23          	sw	zero,-1708(a5) # 80009880 <first.1720>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f5a:	1f0080e7          	jalr	496(ra) # 80007146 <acquire>
  pid = nextpid;
    80000f5e:	00009797          	auipc	a5,0x9
    80000f62:	92678793          	addi	a5,a5,-1754 # 80009884 <nextpid>
  ...
  release(&pid_lock);
    ...
    80000f74:	28a080e7          	jalr	650(ra) # 800071fa <release>
}
...
00000000800010cc <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010ee:	05c080e7          	jalr	92(ra) # 80007146 <acquire>
    if(p->state == UNUSED) {
    ...
    800010fc:	102080e7          	jalr	258(ra) # 800071fa <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    8000116c:	092080e7          	jalr	146(ra) # 800071fa <release>
    return 0;
    ...
    80001184:	07a080e7          	jalr	122(ra) # 800071fa <release>
    return 0;
...
000000008000118c <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    800011b0:	6f458593          	addi	a1,a1,1780 # 800098a0 <initcode>
  ...
  release(&p->lock);
    ...
    80001200:	ffe080e7          	jalr	-2(ra) # 800071fa <release>
}
...
0000000080001282 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    8000131a:	ee4080e7          	jalr	-284(ra) # 800071fa <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001372:	e8c080e7          	jalr	-372(ra) # 800071fa <release>
}
...
000000008000138c <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    800013cc:	d7e080e7          	jalr	-642(ra) # 80007146 <acquire>
      pp->parent = initproc;
    ...
    800013dc:	e22080e7          	jalr	-478(ra) # 800071fa <release>
...
00000000800013f2 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001466:	d98080e7          	jalr	-616(ra) # 800071fa <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001478:	cd2080e7          	jalr	-814(ra) # 80007146 <acquire>
      if(p->state != UNUSED) {
...
00000000800014b6 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    800014d2:	bfe080e7          	jalr	-1026(ra) # 800070cc <holding>
...
000000008000158c <exit>:
{
  ...
  if(p == initproc)
    ...
    800015c8:	638080e7          	jalr	1592(ra) # 80006bfc <panic>
      fileclose(f);
  ...
  acquire(&initproc->lock);
    ...
    80001612:	b38080e7          	jalr	-1224(ra) # 80007146 <acquire>
  wakeup1(initproc);
  ...
  release(&original_parent->lock);
    ...
    8000167a:	b84080e7          	jalr	-1148(ra) # 800071fa <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001692:	56e080e7          	jalr	1390(ra) # 80006bfc <panic>
...
0000000080001696 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800016ae:	a9c080e7          	jalr	-1380(ra) # 80007146 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    800016c4:	b3a080e7          	jalr	-1222(ra) # 800071fa <release>
}
...
00000000800016d2 <sleep>:
{
  ...
  if(lk != &p->lock){  //DOC: sleeplock0
    ...
    800016f6:	a54080e7          	jalr	-1452(ra) # 80007146 <acquire>
    release(lk);
    800016fa:	854a                	mv	a0,s2
    800016fc:	00006097          	auipc	ra,0x6
    80001700:	afe080e7          	jalr	-1282(ra) # 800071fa <release>
  p->chan = chan;
  ...
  p->chan = 0;
    ...
    8000171e:	ae0080e7          	jalr	-1312(ra) # 800071fa <release>
    acquire(lk);
    80001722:	854a                	mv	a0,s2
    80001724:	00006097          	auipc	ra,0x6
    80001728:	a22080e7          	jalr	-1502(ra) # 80007146 <acquire>
}
...
0000000080001750 <wait>:
{
  ...
  acquire(&p->lock);
    ...
    8000177a:	9d0080e7          	jalr	-1584(ra) # 80007146 <acquire>
    havekids = 0;
    ...
    80001804:	946080e7          	jalr	-1722(ra) # 80007146 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001814:	9ea080e7          	jalr	-1558(ra) # 800071fa <release>
        havekids = 1;
    ...
    8000182a:	9d4080e7          	jalr	-1580(ra) # 800071fa <release>
      return -1;
...
0000000080001858 <wakeup>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000188c:	972080e7          	jalr	-1678(ra) # 800071fa <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000189e:	8ac080e7          	jalr	-1876(ra) # 80007146 <acquire>
    if(p->state == SLEEPING && p->chan == chan) {
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018e8:	862080e7          	jalr	-1950(ra) # 80007146 <acquire>
    if(p->pid == pid){
    ...
    800018f8:	906080e7          	jalr	-1786(ra) # 800071fa <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000191a:	8e4080e7          	jalr	-1820(ra) # 800071fa <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001a02:	248080e7          	jalr	584(ra) # 80006c46 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a44:	206080e7          	jalr	518(ra) # 80006c46 <printf>
    printf("\n");
    80001a48:	8552                	mv	a0,s4
    80001a4a:	00005097          	auipc	ra,0x5
    80001a4e:	1fc080e7          	jalr	508(ra) # 80006c46 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001b14:	5a6080e7          	jalr	1446(ra) # 800070b6 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bee:	55c080e7          	jalr	1372(ra) # 80007146 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001c0e:	5f0080e7          	jalr	1520(ra) # 800071fa <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c7e:	fcc080e7          	jalr	-52(ra) # 80006c46 <printf>
    80001c82:	a029                	j	80001c8c <devintr+0x70>
      uartintr();
    80001c84:	00005097          	auipc	ra,0x5
    80001c88:	3e2080e7          	jalr	994(ra) # 80007066 <uartintr>
      plic_complete(irq);
...
0000000080001cd0 <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d22:	53a080e7          	jalr	1338(ra) # 80007258 <lockfree_read4>
    ...
    80001d36:	eca080e7          	jalr	-310(ra) # 80006bfc <panic>
    if(lockfree_read4(&p->killed))
    80001d3a:	03050513          	addi	a0,a0,48
    80001d3e:	00005097          	auipc	ra,0x5
    80001d42:	51a080e7          	jalr	1306(ra) # 80007258 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d6c:	4f0080e7          	jalr	1264(ra) # 80007258 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001db6:	e94080e7          	jalr	-364(ra) # 80006c46 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001dce:	e7c080e7          	jalr	-388(ra) # 80006c46 <printf>
    p->killed = 1;
...
0000000080001de2 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e3c:	dc4080e7          	jalr	-572(ra) # 80006bfc <panic>
    ...
    80001e4c:	db4080e7          	jalr	-588(ra) # 80006bfc <panic>
    printf("scause %p\n", scause);
    ...
    80001e5e:	dec080e7          	jalr	-532(ra) # 80006c46 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001f12:	cee080e7          	jalr	-786(ra) # 80006bfc <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    8000207a:	bd0080e7          	jalr	-1072(ra) # 80006c46 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    800021a0:	faa080e7          	jalr	-86(ra) # 80007146 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021f4:	00a080e7          	jalr	10(ra) # 800071fa <release>
  return 0;
    ...
    80002216:	fe8080e7          	jalr	-24(ra) # 800071fa <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002266:	ee4080e7          	jalr	-284(ra) # 80007146 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000227e:	f80080e7          	jalr	-128(ra) # 800071fa <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800022b6:	e04080e7          	jalr	-508(ra) # 800070b6 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000233e:	e0c080e7          	jalr	-500(ra) # 80007146 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000237e:	e80080e7          	jalr	-384(ra) # 800071fa <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    800023bc:	844080e7          	jalr	-1980(ra) # 80006bfc <panic>
      b->dev = dev;
    ...
    800023dc:	e22080e7          	jalr	-478(ra) # 800071fa <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    8000244c:	7b4080e7          	jalr	1972(ra) # 80006bfc <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002484:	cc6080e7          	jalr	-826(ra) # 80007146 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    800024ce:	d30080e7          	jalr	-720(ra) # 800071fa <release>
}
    ...
    800024ea:	716080e7          	jalr	1814(ra) # 80006bfc <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002506:	c44080e7          	jalr	-956(ra) # 80007146 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    8000251c:	ce2080e7          	jalr	-798(ra) # 800071fa <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002542:	c08080e7          	jalr	-1016(ra) # 80007146 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002558:	ca6080e7          	jalr	-858(ra) # 800071fa <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025de:	622080e7          	jalr	1570(ra) # 80006bfc <panic>
...
00000000800025e2 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800026a4:	55c080e7          	jalr	1372(ra) # 80006bfc <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027ea:	416080e7          	jalr	1046(ra) # 80006bfc <panic>
...
00000000800027ee <iget>:
{
  ...
  acquire(&icache.lock);
    ...
    8000280e:	93c080e7          	jalr	-1732(ra) # 80007146 <acquire>
  empty = 0;
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    ...
    80002854:	9aa080e7          	jalr	-1622(ra) # 800071fa <release>
      return ip;
  ...
  release(&icache.lock);
    ...
    80002884:	97a080e7          	jalr	-1670(ra) # 800071fa <release>
}
    ...
    800028a6:	35a080e7          	jalr	858(ra) # 80006bfc <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    80002926:	2da080e7          	jalr	730(ra) # 80006bfc <panic>
...
000000008000292a <iinit>:
{
  ...
  initlock(&icache.lock, "icache");
    ...
    8000294c:	76e080e7          	jalr	1902(ra) # 800070b6 <initlock>
  for(i = 0; i < NINODE; i++) {
...
000000008000298a <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a0a:	1f6080e7          	jalr	502(ra) # 80006bfc <panic>
...
0000000080002ae4 <idup>:
{
  ...
  acquire(&icache.lock);
    ...
    80002afc:	64e080e7          	jalr	1614(ra) # 80007146 <acquire>
  ip->ref++;
  ...
  release(&icache.lock);
    ...
    80002b12:	6ec080e7          	jalr	1772(ra) # 800071fa <release>
}
...
0000000080002b22 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b5e:	0a2080e7          	jalr	162(ra) # 80006bfc <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002be0:	020080e7          	jalr	32(ra) # 80006bfc <panic>
...
0000000080002be4 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002c2c:	fd4080e7          	jalr	-44(ra) # 80006bfc <panic>
...
0000000080002cdc <iput>:
{
  ...
  acquire(&icache.lock);
    ...
    80002cf6:	454080e7          	jalr	1108(ra) # 80007146 <acquire>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d48:	4b6080e7          	jalr	1206(ra) # 800071fa <release>
    itrunc(ip);
    ...
    80002d7e:	3cc080e7          	jalr	972(ra) # 80007146 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    8000303c:	bc4080e7          	jalr	-1084(ra) # 80006bfc <panic>
    ...
    8000304c:	bb4080e7          	jalr	-1100(ra) # 80006bfc <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
0000000080003450 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003478:	c42080e7          	jalr	-958(ra) # 800070b6 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000350c:	c3e080e7          	jalr	-962(ra) # 80007146 <acquire>
  while(1){
    if(log.committing){
    ...
    80003564:	c9a080e7          	jalr	-870(ra) # 800071fa <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003594:	bb6080e7          	jalr	-1098(ra) # 80007146 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    800035bc:	c42080e7          	jalr	-958(ra) # 800071fa <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035d4:	b76080e7          	jalr	-1162(ra) # 80007146 <acquire>
    log.committing = 0;
    ...
    800035ec:	c12080e7          	jalr	-1006(ra) # 800071fa <release>
}
    ...
    8000360e:	5f2080e7          	jalr	1522(ra) # 80006bfc <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    8000362a:	bd4080e7          	jalr	-1068(ra) # 800071fa <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003710:	a3a080e7          	jalr	-1478(ra) # 80007146 <acquire>
  for (i = 0; i < log.lh.n; i++) {
  ...
  release(&log.lock);
    ...
    800037aa:	a54080e7          	jalr	-1452(ra) # 800071fa <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800037d8:	8e2080e7          	jalr	-1822(ra) # 800070b6 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000380c:	93e080e7          	jalr	-1730(ra) # 80007146 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    8000383a:	9c4080e7          	jalr	-1596(ra) # 800071fa <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003862:	8e8080e7          	jalr	-1816(ra) # 80007146 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    8000387e:	980080e7          	jalr	-1664(ra) # 800071fa <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800038a8:	8a2080e7          	jalr	-1886(ra) # 80007146 <acquire>
  ...
  release(&lk->lk);
    ...
    800038b8:	946080e7          	jalr	-1722(ra) # 800071fa <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003900:	7ba080e7          	jalr	1978(ra) # 800070b6 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003922:	828080e7          	jalr	-2008(ra) # 80007146 <acquire>
  ...
  release(&ftable.lock);
    ...
    8000394e:	8b0080e7          	jalr	-1872(ra) # 800071fa <release>
  return 0;
    ...
    80003966:	898080e7          	jalr	-1896(ra) # 800071fa <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000398e:	7bc080e7          	jalr	1980(ra) # 80007146 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039a8:	856080e7          	jalr	-1962(ra) # 800071fa <release>
  return f;
}
    ...
    800039c4:	23c080e7          	jalr	572(ra) # 80006bfc <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ea:	760080e7          	jalr	1888(ra) # 80007146 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a28:	7d6080e7          	jalr	2006(ra) # 800071fa <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a48:	95a080e7          	jalr	-1702(ra) # 8000639e <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b58:	8da080e7          	jalr	-1830(ra) # 8000642e <sockread>
  ...
  return r;
    ...
    80003be4:	01c080e7          	jalr	28(ra) # 80006bfc <panic>
    return -1;
    ...
    80003bf8:	12078263          	beqz	a5,80003d1c <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003c3a:	8c8080e7          	jalr	-1848(ra) # 800064fe <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003d18:	ee8080e7          	jalr	-280(ra) # 80006bfc <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d88:	332080e7          	jalr	818(ra) # 800070b6 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003e16:	334080e7          	jalr	820(ra) # 80007146 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003e3a:	3c4080e7          	jalr	964(ra) # 800071fa <release>
    kfree((char*)pi);
    ...
    80003e6c:	392080e7          	jalr	914(ra) # 800071fa <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003ea2:	2a8080e7          	jalr	680(ra) # 80007146 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003ec0:	33e080e7          	jalr	830(ra) # 800071fa <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f62:	29c080e7          	jalr	668(ra) # 800071fa <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f98:	1b2080e7          	jalr	434(ra) # 80007146 <acquire>
  ...
  release(&pi->lock);
    ...
    8000402c:	1d2080e7          	jalr	466(ra) # 800071fa <release>
  return i;
}
    ...
    8000404c:	1b2080e7          	jalr	434(ra) # 800071fa <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004154:	aac080e7          	jalr	-1364(ra) # 80006bfc <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    80004586:	67a080e7          	jalr	1658(ra) # 80006bfc <panic>
    dp->nlink++;  // for ".."
...
00000000800048f4 <sys_unlink>:
{
  ...
  return 0;
    ...
    80004a20:	1e0080e7          	jalr	480(ra) # 80006bfc <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    8000505e:	21e080e7          	jalr	542(ra) # 80006278 <sockalloc>
...
00000000800052ac <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800052ca:	df0080e7          	jalr	-528(ra) # 800070b6 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    800053cc:	834080e7          	jalr	-1996(ra) # 80006bfc <panic>
    ...
    800053dc:	824080e7          	jalr	-2012(ra) # 80006bfc <panic>
    ...
    800053ec:	814080e7          	jalr	-2028(ra) # 80006bfc <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000542a:	d20080e7          	jalr	-736(ra) # 80007146 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005664:	b9a080e7          	jalr	-1126(ra) # 800071fa <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056de:	a6c080e7          	jalr	-1428(ra) # 80007146 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005770:	a8e080e7          	jalr	-1394(ra) # 800071fa <release>
}
    ...
    8000578c:	474080e7          	jalr	1140(ra) # 80006bfc <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    800057b4:	906080e7          	jalr	-1786(ra) # 800070b6 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000586e:	428080e7          	jalr	1064(ra) # 80005c92 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005930:	2d0080e7          	jalr	720(ra) # 80006bfc <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005952:	7f8080e7          	jalr	2040(ra) # 80007146 <acquire>
  ...
  if(tx_mbufs[next_index])
    ...
    80005998:	356080e7          	jalr	854(ra) # 80005cea <mbuffree>
  tx_ring[next_index].addr = (uint64)m->head;
    ...
    800059aa:	00479713          	slli	a4,a5,0x4
    800059ae:	972a                	add	a4,a4,a0
    800059b0:	00893683          	ld	a3,8(s2)
    800059b4:	f314                	sd	a3,32(a4)
  tx_ring[next_index].length = (uint16)m->len;
    800059b6:	01092683          	lw	a3,16(s2)
    800059ba:	02d71423          	sh	a3,40(a4) # 4028 <_entry-0x7fffbfd8>
  tx_ring[next_index].cmd = E1000_TXD_CMD_EOP | E1000_TXD_CMD_RS;
    800059be:	46a5                	li	a3,9
    800059c0:	02d705a3          	sb	a3,43(a4)
  tx_mbufs[next_index] = m;
    800059c4:	078e                	slli	a5,a5,0x3
    800059c6:	97aa                	add	a5,a5,a0
    800059c8:	1327b023          	sd	s2,288(a5)
  ...
  release(&e1000_lock);
    ...
    800059e4:	81a080e7          	jalr	-2022(ra) # 800071fa <release>
  return 0;
    ...
    800059fa:	00002097          	auipc	ra,0x2
    800059fe:	800080e7          	jalr	-2048(ra) # 800071fa <release>
      return -1;
...
e1000_intr(void)
{
    ...
    80005a0e:	f04a                	sd	s2,32(sp)
    80005a10:	ec4e                	sd	s3,24(sp)
    80005a12:	e852                	sd	s4,16(sp)
    80005a14:	e456                	sd	s5,8(sp)
    80005a16:	0080                	addi	s0,sp,64
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    80005a18:	00004797          	auipc	a5,0x4
    80005a1c:	6087b783          	ld	a5,1544(a5) # 8000a020 <regs>
    80005a20:	577d                	li	a4,-1
    80005a22:	0ce7a023          	sw	a4,192(a5)
  uint32 next_index = (regs[E1000_RDT]+1)%RX_RING_SIZE;
    80005a26:	670d                	lui	a4,0x3
    80005a28:	97ba                	add	a5,a5,a4
    80005a2a:	8187a783          	lw	a5,-2024(a5)
    80005a2e:	2785                	addiw	a5,a5,1
    80005a30:	00f7f493          	andi	s1,a5,15
  while(rx_ring[next_index].status & E1000_RXD_STAT_DD){
    80005a34:	00449793          	slli	a5,s1,0x4
    80005a38:	00019717          	auipc	a4,0x19
    80005a3c:	5c870713          	addi	a4,a4,1480 # 8001f000 <e1000_lock>
    80005a40:	97ba                	add	a5,a5,a4
    80005a42:	1ac7c783          	lbu	a5,428(a5)
    80005a46:	8b85                	andi	a5,a5,1
    80005a48:	cba5                	beqz	a5,80005ab8 <e1000_intr+0xb2>
    if(rx_ring[next_index].length>MBUF_SIZE){
    80005a4a:	8a3a                	mv	s4,a4
    80005a4c:	6a85                	lui	s5,0x1
    80005a4e:	800a8a93          	addi	s5,s5,-2048 # 800 <_entry-0x7ffff800>
    80005a52:	00449793          	slli	a5,s1,0x4
    80005a56:	97d2                	add	a5,a5,s4
    80005a58:	1a87d783          	lhu	a5,424(a5)
    80005a5c:	0007871b          	sext.w	a4,a5
    80005a60:	06eaef63          	bltu	s5,a4,80005ade <e1000_intr+0xd8>
    rx_mbufs[next_index]->len = rx_ring[next_index].length;
    80005a64:	02049913          	slli	s2,s1,0x20
    80005a68:	02095913          	srli	s2,s2,0x20
    80005a6c:	00349993          	slli	s3,s1,0x3
    80005a70:	99d2                	add	s3,s3,s4
    80005a72:	2a09b703          	ld	a4,672(s3)
    80005a76:	cb1c                	sw	a5,16(a4)
    net_rx(rx_mbufs[next_index]);
    80005a78:	2a09b503          	ld	a0,672(s3)
    80005a7c:	00000097          	auipc	ra,0x0
    80005a80:	3e2080e7          	jalr	994(ra) # 80005e5e <net_rx>
    rx_mbufs[next_index] =  mbufalloc(0);
    80005a84:	4501                	li	a0,0
    80005a86:	00000097          	auipc	ra,0x0
    80005a8a:	20c080e7          	jalr	524(ra) # 80005c92 <mbufalloc>
    80005a8e:	2aa9b023          	sd	a0,672(s3)
    rx_ring[next_index].addr = (uint64)rx_mbufs[next_index]->head;
    80005a92:	00491793          	slli	a5,s2,0x4
    80005a96:	97d2                	add	a5,a5,s4
    80005a98:	6518                	ld	a4,8(a0)
    80005a9a:	1ae7b023          	sd	a4,416(a5)
    rx_ring[next_index].status = 0;
    80005a9e:	1a078623          	sb	zero,428(a5)
    next_index = (next_index+1)%RX_RING_SIZE;
    80005aa2:	0014879b          	addiw	a5,s1,1
    80005aa6:	00f7f493          	andi	s1,a5,15
  while(rx_ring[next_index].status & E1000_RXD_STAT_DD){
    80005aaa:	00449793          	slli	a5,s1,0x4
    80005aae:	97d2                	add	a5,a5,s4
    80005ab0:	1ac7c783          	lbu	a5,428(a5)
    80005ab4:	8b85                	andi	a5,a5,1
    80005ab6:	ffd1                	bnez	a5,80005a52 <e1000_intr+0x4c>
  regs[E1000_RDT] = (next_index-1)%RX_RING_SIZE;
    80005ab8:	34fd                	addiw	s1,s1,-1
    80005aba:	88bd                	andi	s1,s1,15
    80005abc:	00004797          	auipc	a5,0x4
    80005ac0:	5647b783          	ld	a5,1380(a5) # 8000a020 <regs>
    80005ac4:	670d                	lui	a4,0x3
    80005ac6:	97ba                	add	a5,a5,a4
    80005ac8:	8097ac23          	sw	s1,-2024(a5)

  e1000_recv();
}
    80005acc:	70e2                	ld	ra,56(sp)
    80005ace:	7442                	ld	s0,48(sp)
    80005ad0:	74a2                	ld	s1,40(sp)
    80005ad2:	7902                	ld	s2,32(sp)
    80005ad4:	69e2                	ld	s3,24(sp)
    80005ad6:	6a42                	ld	s4,16(sp)
    80005ad8:	6aa2                	ld	s5,8(sp)
    80005ada:	6121                	addi	sp,sp,64
    80005adc:	8082                	ret
        panic("MBUF_SIZE OVERFLOW!");
    80005ade:	00004517          	auipc	a0,0x4
    80005ae2:	ce250513          	addi	a0,a0,-798 # 800097c0 <syscalls+0x410>
    80005ae6:	00001097          	auipc	ra,0x1
    80005aea:	116080e7          	jalr	278(ra) # 80006bfc <panic>

0000000080005aee <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005af0:	ec22                	sd	s0,24(sp)
    80005af2:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005af4:	fe041723          	sh	zero,-18(s0)
  /*
   ...
   */
  while (nleft > 1)  {
    80005af8:	4785                	li	a5,1
    80005afa:	04b7d963          	bge	a5,a1,80005b4c <in_cksum+0x5e>
    80005afe:	ffe5879b          	addiw	a5,a1,-2
    80005b02:	0017d61b          	srliw	a2,a5,0x1
    80005b06:	0017d71b          	srliw	a4,a5,0x1
    80005b0a:	0705                	addi	a4,a4,1
    80005b0c:	0706                	slli	a4,a4,0x1
    80005b0e:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005b10:	4781                	li	a5,0
    sum += *w++;
    80005b12:	0509                	addi	a0,a0,2
    80005b14:	ffe55683          	lhu	a3,-2(a0)
    80005b18:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b1a:	fee51ce3          	bne	a0,a4,80005b12 <in_cksum+0x24>
    80005b1e:	35f9                	addiw	a1,a1,-2
    80005b20:	0016169b          	slliw	a3,a2,0x1
    80005b24:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }

  /* mop up an odd byte, if necessary */
  if (nleft == 1) {
    80005b26:	4685                	li	a3,1
    80005b28:	02d58563          	beq	a1,a3,80005b52 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b2c:	03079513          	slli	a0,a5,0x30
    80005b30:	9141                	srli	a0,a0,0x30
    80005b32:	0107d79b          	srliw	a5,a5,0x10
    80005b36:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b38:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b3c:	9d3d                	addw	a0,a0,a5
    80005b3e:	fff54513          	not	a0,a0
  return answer;
}
    80005b42:	1542                	slli	a0,a0,0x30
    80005b44:	9141                	srli	a0,a0,0x30
    80005b46:	6462                	ld	s0,24(sp)
    80005b48:	6105                	addi	sp,sp,32
    80005b4a:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b4c:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b4e:	4781                	li	a5,0
    80005b50:	bfd9                	j	80005b26 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b52:	00074703          	lbu	a4,0(a4) # 3000 <_entry-0x7fffd000>
    80005b56:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b5a:	fee45703          	lhu	a4,-18(s0)
    80005b5e:	9fb9                	addw	a5,a5,a4
    80005b60:	b7f1                	j	80005b2c <in_cksum+0x3e>

0000000080005b62 <mbufpull>:
{
    80005b62:	1141                	addi	sp,sp,-16
    80005b64:	e422                	sd	s0,8(sp)
    80005b66:	0800                	addi	s0,sp,16
    80005b68:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b6a:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b6c:	4b98                	lw	a4,16(a5)
    80005b6e:	00b76b63          	bltu	a4,a1,80005b84 <mbufpull+0x22>
  m->len -= len;
    80005b72:	9f0d                	subw	a4,a4,a1
    80005b74:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b76:	1582                	slli	a1,a1,0x20
    80005b78:	9181                	srli	a1,a1,0x20
    80005b7a:	95aa                	add	a1,a1,a0
    80005b7c:	e78c                	sd	a1,8(a5)
}
    80005b7e:	6422                	ld	s0,8(sp)
    80005b80:	0141                	addi	sp,sp,16
    80005b82:	8082                	ret
    return 0;
    80005b84:	4501                	li	a0,0
    80005b86:	bfe5                	j	80005b7e <mbufpull+0x1c>

0000000080005b88 <mbufpush>:
{
    80005b88:	87aa                	mv	a5,a0
  m->head -= len;
    80005b8a:	02059713          	slli	a4,a1,0x20
    80005b8e:	9301                	srli	a4,a4,0x20
    80005b90:	6508                	ld	a0,8(a0)
    80005b92:	8d19                	sub	a0,a0,a4
    80005b94:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b96:	01478713          	addi	a4,a5,20
    80005b9a:	00e56663          	bltu	a0,a4,80005ba6 <mbufpush+0x1e>
  m->len += len;
    80005b9e:	4b98                	lw	a4,16(a5)
    80005ba0:	9db9                	addw	a1,a1,a4
    80005ba2:	cb8c                	sw	a1,16(a5)
}
    80005ba4:	8082                	ret
{
    ...
    panic("mbufpush");
    80005bae:	00004517          	auipc	a0,0x4
    80005bb2:	c2a50513          	addi	a0,a0,-982 # 800097d8 <syscalls+0x428>
    80005bb6:	00001097          	auipc	ra,0x1
    80005bba:	046080e7          	jalr	70(ra) # 80006bfc <panic>

0000000080005bbe <net_tx_eth>:

// sends an ethernet packet
static void
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    80005bbe:	7179                	addi	sp,sp,-48
    80005bc0:	f406                	sd	ra,40(sp)
    80005bc2:	f022                	sd	s0,32(sp)
    80005bc4:	ec26                	sd	s1,24(sp)
    80005bc6:	e84a                	sd	s2,16(sp)
    80005bc8:	e44e                	sd	s3,8(sp)
    80005bca:	1800                	addi	s0,sp,48
    80005bcc:	89aa                	mv	s3,a0
    80005bce:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bd0:	45b9                	li	a1,14
    80005bd2:	00000097          	auipc	ra,0x0
    80005bd6:	fb6080e7          	jalr	-74(ra) # 80005b88 <mbufpush>
    80005bda:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005bdc:	4619                	li	a2,6
    80005bde:	00004597          	auipc	a1,0x4
    80005be2:	cb258593          	addi	a1,a1,-846 # 80009890 <local_mac>
    80005be6:	0519                	addi	a0,a0,6
    80005be8:	ffffa097          	auipc	ra,0xffffa
    80005bec:	5f0080e7          	jalr	1520(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bf0:	4619                	li	a2,6
    80005bf2:	00004597          	auipc	a1,0x4
    80005bf6:	c9658593          	addi	a1,a1,-874 # 80009888 <broadcast_mac>
    80005bfa:	8526                	mv	a0,s1
    80005bfc:	ffffa097          	auipc	ra,0xffffa
    80005c00:	5dc080e7          	jalr	1500(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005c04:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005c08:	00f48623          	sb	a5,12(s1)
    80005c0c:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005c10:	854e                	mv	a0,s3
    80005c12:	00000097          	auipc	ra,0x0
    80005c16:	d22080e7          	jalr	-734(ra) # 80005934 <e1000_transmit>
    80005c1a:	e901                	bnez	a0,80005c2a <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    ...
    80005c24:	69a2                	ld	s3,8(sp)
    80005c26:	6145                	addi	sp,sp,48
    80005c28:	8082                	ret
  kfree(m);
    80005c2a:	854e                	mv	a0,s3
    80005c2c:	ffffa097          	auipc	ra,0xffffa
    80005c30:	3f0080e7          	jalr	1008(ra) # 8000001c <kfree>
}
    80005c34:	b7e5                	j	80005c1c <net_tx_eth+0x5e>

0000000080005c36 <mbufput>:
{
    80005c36:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c38:	4918                	lw	a4,16(a0)
    80005c3a:	02071693          	slli	a3,a4,0x20
    80005c3e:	9281                	srli	a3,a3,0x20
    80005c40:	6508                	ld	a0,8(a0)
    80005c42:	9536                	add	a0,a0,a3
  m->len += len;
    80005c44:	9f2d                	addw	a4,a4,a1
    80005c46:	0007069b          	sext.w	a3,a4
    80005c4a:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c4c:	6785                	lui	a5,0x1
    80005c4e:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c52:	00d7e363          	bltu	a5,a3,80005c58 <mbufput+0x22>
}
    80005c56:	8082                	ret
{
    ...
    80005c64:	b8850513          	addi	a0,a0,-1144 # 800097e8 <syscalls+0x438>
    80005c68:	00001097          	auipc	ra,0x1
    80005c6c:	f94080e7          	jalr	-108(ra) # 80006bfc <panic>

0000000080005c70 <mbuftrim>:
{
    80005c70:	1141                	addi	sp,sp,-16
    80005c72:	e422                	sd	s0,8(sp)
    80005c74:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c76:	491c                	lw	a5,16(a0)
    80005c78:	00b7eb63          	bltu	a5,a1,80005c8e <mbuftrim+0x1e>
  m->len -= len;
    80005c7c:	9f8d                	subw	a5,a5,a1
    80005c7e:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c80:	1782                	slli	a5,a5,0x20
    80005c82:	9381                	srli	a5,a5,0x20
    80005c84:	6508                	ld	a0,8(a0)
    ...
    80005c90:	bfe5                	j	80005c88 <mbuftrim+0x18>

0000000080005c92 <mbufalloc>:
{
    80005c92:	1101                	addi	sp,sp,-32
    80005c94:	ec06                	sd	ra,24(sp)
    80005c96:	e822                	sd	s0,16(sp)
    80005c98:	e426                	sd	s1,8(sp)
    80005c9a:	e04a                	sd	s2,0(sp)
    80005c9c:	1000                	addi	s0,sp,32
  if (headroom > MBUF_SIZE)
    80005c9e:	6785                	lui	a5,0x1
    80005ca0:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005ca4:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005ca6:	02a7eb63          	bltu	a5,a0,80005cdc <mbufalloc+0x4a>
    80005caa:	84aa                	mv	s1,a0
  m = kalloc();
    80005cac:	ffffa097          	auipc	ra,0xffffa
    80005cb0:	46c080e7          	jalr	1132(ra) # 80000118 <kalloc>
    80005cb4:	892a                	mv	s2,a0
  if (m == 0)
    80005cb6:	c11d                	beqz	a0,80005cdc <mbufalloc+0x4a>
  m->next = 0;
    80005cb8:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005cbc:	0551                	addi	a0,a0,20
    80005cbe:	1482                	slli	s1,s1,0x20
    80005cc0:	9081                	srli	s1,s1,0x20
    80005cc2:	94aa                	add	s1,s1,a0
    80005cc4:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005cc8:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005ccc:	6605                	lui	a2,0x1
    80005cce:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cd2:	4581                	li	a1,0
    80005cd4:	ffffa097          	auipc	ra,0xffffa
    80005cd8:	4a4080e7          	jalr	1188(ra) # 80000178 <memset>
}
...
0000000080005cea <mbuffree>:
{
  ...
  kfree(m);
    80005cf2:	ffffa097          	auipc	ra,0xffffa
    80005cf6:	32a080e7          	jalr	810(ra) # 8000001c <kfree>
}
    80005cfa:	60a2                	ld	ra,8(sp)
    80005cfc:	6402                	ld	s0,0(sp)
    80005cfe:	0141                	addi	sp,sp,16
    80005d00:	8082                	ret

0000000080005d02 <mbufq_pushtail>:
{
    80005d02:	1141                	addi	sp,sp,-16
    80005d04:	e422                	sd	s0,8(sp)
    80005d06:	0800                	addi	s0,sp,16
  m->next = 0;
    80005d08:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005d0c:	611c                	ld	a5,0(a0)
    80005d0e:	c799                	beqz	a5,80005d1c <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005d10:	651c                	ld	a5,8(a0)
    80005d12:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d14:	e50c                	sd	a1,8(a0)
}
    80005d16:	6422                	ld	s0,8(sp)
    80005d18:	0141                	addi	sp,sp,16
    80005d1a:	8082                	ret
    q->head = q->tail = m;
    80005d1c:	e50c                	sd	a1,8(a0)
    80005d1e:	e10c                	sd	a1,0(a0)
    return;
    80005d20:	bfdd                	j	80005d16 <mbufq_pushtail+0x14>

0000000080005d22 <mbufq_pophead>:
{
  ...
  struct mbuf *head = q->head;
    80005d2a:	6108                	ld	a0,0(a0)
  if (!head)
    80005d2c:	c119                	beqz	a0,80005d32 <mbufq_pophead+0x10>
  q->head = head->next;
    80005d2e:	6118                	ld	a4,0(a0)
...
0000000080005d38 <mbufq_empty>:
{
    80005d38:	1141                	addi	sp,sp,-16
    80005d3a:	e422                	sd	s0,8(sp)
    80005d3c:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d3e:	6108                	ld	a0,0(a0)
}
    80005d40:	00153513          	seqz	a0,a0
    80005d44:	6422                	ld	s0,8(sp)
    80005d46:	0141                	addi	sp,sp,16
    80005d48:	8082                	ret

0000000080005d4a <mbufq_init>:
{
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d64:	e44e                	sd	s3,8(sp)
    80005d66:	e052                	sd	s4,0(sp)
    80005d68:	1800                	addi	s0,sp,48
    80005d6a:	8a2a                	mv	s4,a0
    80005d6c:	892e                	mv	s2,a1
    80005d6e:	89b2                	mv	s3,a2
    80005d70:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d72:	45a1                	li	a1,8
    80005d74:	00000097          	auipc	ra,0x0
    80005d78:	e14080e7          	jalr	-492(ra) # 80005b88 <mbufpush>
    80005d7c:	0089d61b          	srliw	a2,s3,0x8
    80005d80:	0089999b          	slliw	s3,s3,0x8
    80005d84:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d88:	01351023          	sh	s3,0(a0)
    80005d8c:	0084d69b          	srliw	a3,s1,0x8
    80005d90:	0084949b          	slliw	s1,s1,0x8
    80005d94:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d96:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d9a:	010a2783          	lw	a5,16(s4)
    80005d9e:	0087d713          	srli	a4,a5,0x8
    80005da2:	0087979b          	slliw	a5,a5,0x8
    80005da6:	0ff77713          	andi	a4,a4,255
    80005daa:	8fd9                	or	a5,a5,a4
    80005dac:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005db0:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005db4:	45d1                	li	a1,20
    80005db6:	8552                	mv	a0,s4
    80005db8:	00000097          	auipc	ra,0x0
    80005dbc:	dd0080e7          	jalr	-560(ra) # 80005b88 <mbufpush>
    80005dc0:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005dc2:	4651                	li	a2,20
    80005dc4:	4581                	li	a1,0
    80005dc6:	ffffa097          	auipc	ra,0xffffa
    80005dca:	3b2080e7          	jalr	946(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005dce:	04500793          	li	a5,69
    80005dd2:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005dd6:	47c5                	li	a5,17
    80005dd8:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005ddc:	0f0207b7          	lui	a5,0xf020
    80005de0:	27a9                	addiw	a5,a5,10
    80005de2:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005de4:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005de8:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005dec:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005dee:	0089171b          	slliw	a4,s2,0x8
    80005df2:	00ff06b7          	lui	a3,0xff0
    80005df6:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005df8:	8fd9                	or	a5,a5,a4
    80005dfa:	0089591b          	srliw	s2,s2,0x8
    80005dfe:	65c1                	lui	a1,0x10
    80005e00:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005e04:	00b97933          	and	s2,s2,a1
    80005e08:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005e0c:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005e10:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e14:	0087d713          	srli	a4,a5,0x8
    80005e18:	0087979b          	slliw	a5,a5,0x8
    80005e1c:	0ff77713          	andi	a4,a4,255
    80005e20:	8fd9                	or	a5,a5,a4
    80005e22:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e26:	06400793          	li	a5,100
    80005e2a:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e2e:	45d1                	li	a1,20
    80005e30:	8526                	mv	a0,s1
    80005e32:	00000097          	auipc	ra,0x0
    80005e36:	cbc080e7          	jalr	-836(ra) # 80005aee <in_cksum>
    80005e3a:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e3e:	6585                	lui	a1,0x1
    80005e40:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e44:	8552                	mv	a0,s4
    80005e46:	00000097          	auipc	ra,0x0
    80005e4a:	d78080e7          	jalr	-648(ra) # 80005bbe <net_tx_eth>

  // now on to the IP layer
  net_tx_ip(m, IPPROTO_UDP, dip);
}
    80005e4e:	70a2                	ld	ra,40(sp)
    80005e50:	7402                	ld	s0,32(sp)
    80005e52:	64e2                	ld	s1,24(sp)
    80005e54:	6942                	ld	s2,16(sp)
    80005e56:	69a2                	ld	s3,8(sp)
    80005e58:	6a02                	ld	s4,0(sp)
    80005e5a:	6145                	addi	sp,sp,48
    80005e5c:	8082                	ret

0000000080005e5e <net_rx>:
}
...
{
    80005e5e:	715d                	addi	sp,sp,-80
    80005e60:	e486                	sd	ra,72(sp)
    80005e62:	e0a2                	sd	s0,64(sp)
    80005e64:	fc26                	sd	s1,56(sp)
    80005e66:	f84a                	sd	s2,48(sp)
    80005e68:	f44e                	sd	s3,40(sp)
    80005e6a:	f052                	sd	s4,32(sp)
    80005e6c:	ec56                	sd	s5,24(sp)
    80005e6e:	0880                	addi	s0,sp,80
    80005e70:	84aa                	mv	s1,a0
  struct eth *ethhdr;
  uint16 type;

  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e72:	45b9                	li	a1,14
    80005e74:	00000097          	auipc	ra,0x0
    80005e78:	cee080e7          	jalr	-786(ra) # 80005b62 <mbufpull>
  if (!ethhdr) {
    80005e7c:	c521                	beqz	a0,80005ec4 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e7e:	00c54783          	lbu	a5,12(a0)
    80005e82:	00d54703          	lbu	a4,13(a0)
    80005e86:	0722                	slli	a4,a4,0x8
    80005e88:	8fd9                	or	a5,a5,a4
    80005e8a:	0087979b          	slliw	a5,a5,0x8
    80005e8e:	8321                	srli	a4,a4,0x8
    80005e90:	8fd9                	or	a5,a5,a4
    80005e92:	17c2                	slli	a5,a5,0x30
    80005e94:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e96:	8007871b          	addiw	a4,a5,-2048
    80005e9a:	cb1d                	beqz	a4,80005ed0 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005e9c:	2781                	sext.w	a5,a5
    80005e9e:	6705                	lui	a4,0x1
    80005ea0:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005ea4:	18e78e63          	beq	a5,a4,80006040 <net_rx+0x1e2>
  kfree(m);
    80005ea8:	8526                	mv	a0,s1
    80005eaa:	ffffa097          	auipc	ra,0xffffa
    80005eae:	172080e7          	jalr	370(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
    80005eb2:	60a6                	ld	ra,72(sp)
    80005eb4:	6406                	ld	s0,64(sp)
    80005eb6:	74e2                	ld	s1,56(sp)
    80005eb8:	7942                	ld	s2,48(sp)
    80005eba:	79a2                	ld	s3,40(sp)
    80005ebc:	7a02                	ld	s4,32(sp)
    80005ebe:	6ae2                	ld	s5,24(sp)
    80005ec0:	6161                	addi	sp,sp,80
    80005ec2:	8082                	ret
  kfree(m);
    80005ec4:	8526                	mv	a0,s1
    80005ec6:	ffffa097          	auipc	ra,0xffffa
    80005eca:	156080e7          	jalr	342(ra) # 8000001c <kfree>
}
    80005ece:	b7d5                	j	80005eb2 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005ed0:	45d1                	li	a1,20
    80005ed2:	8526                	mv	a0,s1
    80005ed4:	00000097          	auipc	ra,0x0
    80005ed8:	c8e080e7          	jalr	-882(ra) # 80005b62 <mbufpull>
    80005edc:	892a                	mv	s2,a0
  if (!iphdr)
    80005ede:	c519                	beqz	a0,80005eec <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ee0:	00054703          	lbu	a4,0(a0)
    80005ee4:	04500793          	li	a5,69
    80005ee8:	00f70863          	beq	a4,a5,80005ef8 <net_rx+0x9a>
  kfree(m);
    80005eec:	8526                	mv	a0,s1
    80005eee:	ffffa097          	auipc	ra,0xffffa
    80005ef2:	12e080e7          	jalr	302(ra) # 8000001c <kfree>
}
    80005ef6:	bf75                	j	80005eb2 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005ef8:	45d1                	li	a1,20
    80005efa:	00000097          	auipc	ra,0x0
    80005efe:	bf4080e7          	jalr	-1036(ra) # 80005aee <in_cksum>
    80005f02:	f56d                	bnez	a0,80005eec <net_rx+0x8e>
    80005f04:	00695783          	lhu	a5,6(s2)
    80005f08:	0087d713          	srli	a4,a5,0x8
    80005f0c:	0087979b          	slliw	a5,a5,0x8
    80005f10:	0ff77713          	andi	a4,a4,255
    80005f14:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f16:	17c2                	slli	a5,a5,0x30
    80005f18:	93c1                	srli	a5,a5,0x30
    80005f1a:	fbe9                	bnez	a5,80005eec <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f1c:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f20:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f24:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f28:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f2a:	0087169b          	slliw	a3,a4,0x8
    80005f2e:	00ff0637          	lui	a2,0xff0
    80005f32:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f34:	8fd5                	or	a5,a5,a3
    80005f36:	0087571b          	srliw	a4,a4,0x8
    80005f3a:	66c1                	lui	a3,0x10
    80005f3c:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f40:	8f75                	and	a4,a4,a3
    80005f42:	8fd9                	or	a5,a5,a4
    80005f44:	2781                	sext.w	a5,a5
    80005f46:	0a000737          	lui	a4,0xa000
    80005f4a:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f4e:	f8e79fe3          	bne	a5,a4,80005eec <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f52:	00994703          	lbu	a4,9(s2)
    80005f56:	47c5                	li	a5,17
    80005f58:	f8f71ae3          	bne	a4,a5,80005eec <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f5c:	00295783          	lhu	a5,2(s2)
    80005f60:	0087d713          	srli	a4,a5,0x8
    80005f64:	0087999b          	slliw	s3,a5,0x8
    80005f68:	0ff77793          	andi	a5,a4,255
    80005f6c:	00f9e9b3          	or	s3,s3,a5
    80005f70:	19c2                	slli	s3,s3,0x30
    80005f72:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f76:	fec9879b          	addiw	a5,s3,-20
    80005f7a:	03079a13          	slli	s4,a5,0x30
    80005f7e:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f82:	45a1                	li	a1,8
    80005f84:	8526                	mv	a0,s1
    80005f86:	00000097          	auipc	ra,0x0
    80005f8a:	bdc080e7          	jalr	-1060(ra) # 80005b62 <mbufpull>
    80005f8e:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f90:	c915                	beqz	a0,80005fc4 <net_rx+0x166>
    80005f92:	00455783          	lhu	a5,4(a0)
    80005f96:	0087d713          	srli	a4,a5,0x8
    80005f9a:	0087979b          	slliw	a5,a5,0x8
    80005f9e:	0ff77713          	andi	a4,a4,255
    80005fa2:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005fa4:	2a01                	sext.w	s4,s4
    80005fa6:	17c2                	slli	a5,a5,0x30
    80005fa8:	93c1                	srli	a5,a5,0x30
    80005faa:	00fa1d63          	bne	s4,a5,80005fc4 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005fae:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fb2:	0107979b          	slliw	a5,a5,0x10
    80005fb6:	0107d79b          	srliw	a5,a5,0x10
    80005fba:	0007871b          	sext.w	a4,a5
    80005fbe:	488c                	lw	a1,16(s1)
    80005fc0:	00e5f863          	bgeu	a1,a4,80005fd0 <net_rx+0x172>
  kfree(m);
    80005fc4:	8526                	mv	a0,s1
    80005fc6:	ffffa097          	auipc	ra,0xffffa
    80005fca:	056080e7          	jalr	86(ra) # 8000001c <kfree>
}
    80005fce:	b5d5                	j	80005eb2 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fd0:	9d9d                	subw	a1,a1,a5
    80005fd2:	8526                	mv	a0,s1
    80005fd4:	00000097          	auipc	ra,0x0
    80005fd8:	c9c080e7          	jalr	-868(ra) # 80005c70 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fdc:	00c92783          	lw	a5,12(s2)
    80005fe0:	000ad703          	lhu	a4,0(s5)
    80005fe4:	00875693          	srli	a3,a4,0x8
    80005fe8:	0087171b          	slliw	a4,a4,0x8
    80005fec:	0ff6f693          	andi	a3,a3,255
    80005ff0:	8ed9                	or	a3,a3,a4
    80005ff2:	002ad703          	lhu	a4,2(s5)
    80005ff6:	00875613          	srli	a2,a4,0x8
    80005ffa:	0087171b          	slliw	a4,a4,0x8
    80005ffe:	0ff67613          	andi	a2,a2,255
    80006002:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80006004:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006008:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000600c:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    8000600e:	0087959b          	slliw	a1,a5,0x8
    80006012:	00ff0537          	lui	a0,0xff0
    80006016:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80006018:	8f4d                	or	a4,a4,a1
    8000601a:	0087d79b          	srliw	a5,a5,0x8
    8000601e:	65c1                	lui	a1,0x10
    80006020:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006024:	8fed                	and	a5,a5,a1
    80006026:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80006028:	16c2                	slli	a3,a3,0x30
    8000602a:	92c1                	srli	a3,a3,0x30
    8000602c:	1642                	slli	a2,a2,0x30
    8000602e:	9241                	srli	a2,a2,0x30
    80006030:	0007859b          	sext.w	a1,a5
    80006034:	8526                	mv	a0,s1
    80006036:	00000097          	auipc	ra,0x0
    8000603a:	55c080e7          	jalr	1372(ra) # 80006592 <sockrecvudp>
  return;
    8000603e:	bd95                	j	80005eb2 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006040:	45f1                	li	a1,28
    80006042:	8526                	mv	a0,s1
    80006044:	00000097          	auipc	ra,0x0
    80006048:	b1e080e7          	jalr	-1250(ra) # 80005b62 <mbufpull>
    8000604c:	892a                	mv	s2,a0
  if (!arphdr)
    8000604e:	c179                	beqz	a0,80006114 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006050:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006054:	00154703          	lbu	a4,1(a0)
    80006058:	0722                	slli	a4,a4,0x8
    8000605a:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000605c:	0087979b          	slliw	a5,a5,0x8
    80006060:	8321                	srli	a4,a4,0x8
    80006062:	8fd9                	or	a5,a5,a4
    80006064:	17c2                	slli	a5,a5,0x30
    80006066:	93c1                	srli	a5,a5,0x30
    80006068:	4705                	li	a4,1
    8000606a:	0ae79563          	bne	a5,a4,80006114 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    8000606e:	00254783          	lbu	a5,2(a0)
    80006072:	00354703          	lbu	a4,3(a0)
    80006076:	0722                	slli	a4,a4,0x8
    80006078:	8fd9                	or	a5,a5,a4
    8000607a:	0087979b          	slliw	a5,a5,0x8
    8000607e:	8321                	srli	a4,a4,0x8
    80006080:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006082:	0107979b          	slliw	a5,a5,0x10
    80006086:	0107d79b          	srliw	a5,a5,0x10
    8000608a:	8007879b          	addiw	a5,a5,-2048
    8000608e:	e3d9                	bnez	a5,80006114 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006090:	00454703          	lbu	a4,4(a0)
    80006094:	4799                	li	a5,6
    80006096:	06f71f63          	bne	a4,a5,80006114 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    8000609a:	00554703          	lbu	a4,5(a0)
    8000609e:	4791                	li	a5,4
    800060a0:	06f71a63          	bne	a4,a5,80006114 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060a4:	00654783          	lbu	a5,6(a0)
    800060a8:	00754703          	lbu	a4,7(a0)
    800060ac:	0722                	slli	a4,a4,0x8
    800060ae:	8fd9                	or	a5,a5,a4
    800060b0:	0087979b          	slliw	a5,a5,0x8
    800060b4:	8321                	srli	a4,a4,0x8
    800060b6:	8fd9                	or	a5,a5,a4
    800060b8:	17c2                	slli	a5,a5,0x30
    800060ba:	93c1                	srli	a5,a5,0x30
    800060bc:	4705                	li	a4,1
    800060be:	04e79b63          	bne	a5,a4,80006114 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060c2:	01854783          	lbu	a5,24(a0)
    800060c6:	01954703          	lbu	a4,25(a0)
    800060ca:	0722                	slli	a4,a4,0x8
    800060cc:	8f5d                	or	a4,a4,a5
    800060ce:	01a54783          	lbu	a5,26(a0)
    800060d2:	07c2                	slli	a5,a5,0x10
    800060d4:	8f5d                	or	a4,a4,a5
    800060d6:	01b54783          	lbu	a5,27(a0)
    800060da:	07e2                	slli	a5,a5,0x18
    800060dc:	8fd9                	or	a5,a5,a4
    800060de:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060e2:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060e6:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060ea:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060ec:	0087169b          	slliw	a3,a4,0x8
    800060f0:	00ff0637          	lui	a2,0xff0
    800060f4:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060f6:	8fd5                	or	a5,a5,a3
    800060f8:	0087571b          	srliw	a4,a4,0x8
    800060fc:	66c1                	lui	a3,0x10
    800060fe:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006102:	8f75                	and	a4,a4,a3
    80006104:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006106:	2781                	sext.w	a5,a5
    80006108:	0a000737          	lui	a4,0xa000
    8000610c:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80006110:	00e78863          	beq	a5,a4,80006120 <net_rx+0x2c2>
  kfree(m);
    80006114:	8526                	mv	a0,s1
    80006116:	ffffa097          	auipc	ra,0xffffa
    8000611a:	f06080e7          	jalr	-250(ra) # 8000001c <kfree>
}
    8000611e:	bb51                	j	80005eb2 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    80006120:	4619                	li	a2,6
    80006122:	00850593          	addi	a1,a0,8
    80006126:	fb840513          	addi	a0,s0,-72
    8000612a:	ffffa097          	auipc	ra,0xffffa
    8000612e:	0ae080e7          	jalr	174(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006132:	00e94783          	lbu	a5,14(s2)
    80006136:	00f94703          	lbu	a4,15(s2)
    8000613a:	0722                	slli	a4,a4,0x8
    8000613c:	8f5d                	or	a4,a4,a5
    8000613e:	01094783          	lbu	a5,16(s2)
    80006142:	07c2                	slli	a5,a5,0x10
    80006144:	8f5d                	or	a4,a4,a5
    80006146:	01194783          	lbu	a5,17(s2)
    8000614a:	07e2                	slli	a5,a5,0x18
    8000614c:	8fd9                	or	a5,a5,a4
    8000614e:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006152:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006156:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000615a:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    8000615e:	0087179b          	slliw	a5,a4,0x8
    80006162:	00ff06b7          	lui	a3,0xff0
    80006166:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006168:	00f96933          	or	s2,s2,a5
    8000616c:	0087579b          	srliw	a5,a4,0x8
    80006170:	6741                	lui	a4,0x10
    80006172:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006176:	8ff9                	and	a5,a5,a4
    80006178:	00f96933          	or	s2,s2,a5
    8000617c:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    8000617e:	08000513          	li	a0,128
    80006182:	00000097          	auipc	ra,0x0
    80006186:	b10080e7          	jalr	-1264(ra) # 80005c92 <mbufalloc>
    8000618a:	8a2a                	mv	s4,a0
  if (!m)
    8000618c:	d541                	beqz	a0,80006114 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    8000618e:	45f1                	li	a1,28
    80006190:	00000097          	auipc	ra,0x0
    80006194:	aa6080e7          	jalr	-1370(ra) # 80005c36 <mbufput>
    80006198:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000619a:	00050023          	sb	zero,0(a0)
    8000619e:	4785                	li	a5,1
    800061a0:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    800061a4:	47a1                	li	a5,8
    800061a6:	00f50123          	sb	a5,2(a0)
    800061aa:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    800061ae:	4799                	li	a5,6
    800061b0:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061b4:	4791                	li	a5,4
    800061b6:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061ba:	00050323          	sb	zero,6(a0)
    800061be:	4a89                	li	s5,2
    800061c0:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061c4:	4619                	li	a2,6
    800061c6:	00003597          	auipc	a1,0x3
    800061ca:	6ca58593          	addi	a1,a1,1738 # 80009890 <local_mac>
    800061ce:	0521                	addi	a0,a0,8
    800061d0:	ffffa097          	auipc	ra,0xffffa
    800061d4:	008080e7          	jalr	8(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061d8:	47a9                	li	a5,10
    800061da:	00f98723          	sb	a5,14(s3)
    800061de:	000987a3          	sb	zero,15(s3)
    800061e2:	01598823          	sb	s5,16(s3)
    800061e6:	47bd                	li	a5,15
    800061e8:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061ec:	4619                	li	a2,6
    800061ee:	fb840593          	addi	a1,s0,-72
    800061f2:	01298513          	addi	a0,s3,18
    800061f6:	ffffa097          	auipc	ra,0xffffa
    800061fa:	fe2080e7          	jalr	-30(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    800061fe:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    80006202:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006206:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    80006208:	0089179b          	slliw	a5,s2,0x8
    8000620c:	00ff06b7          	lui	a3,0xff0
    80006210:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006212:	8f5d                	or	a4,a4,a5
    80006214:	0089579b          	srliw	a5,s2,0x8
    80006218:	66c1                	lui	a3,0x10
    8000621a:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    8000621e:	8ff5                	and	a5,a5,a3
    80006220:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80006222:	00e98c23          	sb	a4,24(s3)
    80006226:	0087d71b          	srliw	a4,a5,0x8
    8000622a:	00e98ca3          	sb	a4,25(s3)
    8000622e:	0107d71b          	srliw	a4,a5,0x10
    80006232:	00e98d23          	sb	a4,26(s3)
    80006236:	0187d79b          	srliw	a5,a5,0x18
    8000623a:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    8000623e:	6585                	lui	a1,0x1
    80006240:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006244:	8552                	mv	a0,s4
    80006246:	00000097          	auipc	ra,0x0
    8000624a:	978080e7          	jalr	-1672(ra) # 80005bbe <net_tx_eth>
  return 0;
    8000624e:	b5d9                	j	80006114 <net_rx+0x2b6>

0000000080006250 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    80006258:	00003597          	auipc	a1,0x3
    8000625c:	59858593          	addi	a1,a1,1432 # 800097f0 <syscalls+0x440>
    80006260:	00019517          	auipc	a0,0x19
    80006264:	0c050513          	addi	a0,a0,192 # 8001f320 <lock>
    80006268:	00001097          	auipc	ra,0x1
    8000626c:	e4e080e7          	jalr	-434(ra) # 800070b6 <initlock>
}
...
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    8000628c:	84ae                	mv	s1,a1
    8000628e:	8a32                	mv	s4,a2
    80006290:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80006292:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    80006296:	ffffd097          	auipc	ra,0xffffd
    8000629a:	676080e7          	jalr	1654(ra) # 8000390c <filealloc>
    8000629e:	00a93023          	sd	a0,0(s2)
    800062a2:	c975                	beqz	a0,80006396 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    800062a4:	ffffa097          	auipc	ra,0xffffa
    800062a8:	e74080e7          	jalr	-396(ra) # 80000118 <kalloc>
    800062ac:	8aaa                	mv	s5,a0
    800062ae:	c15d                	beqz	a0,80006354 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    800062b0:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062b2:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062b6:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062ba:	00003597          	auipc	a1,0x3
    800062be:	53e58593          	addi	a1,a1,1342 # 800097f8 <syscalls+0x448>
    800062c2:	0541                	addi	a0,a0,16
    800062c4:	00001097          	auipc	ra,0x1
    800062c8:	df2080e7          	jalr	-526(ra) # 800070b6 <initlock>
  mbufq_init(&si->rxq);
    800062cc:	028a8513          	addi	a0,s5,40
    800062d0:	00000097          	auipc	ra,0x0
    800062d4:	a7a080e7          	jalr	-1414(ra) # 80005d4a <mbufq_init>
  (*f)->type = FD_SOCK;
    800062d8:	00093783          	ld	a5,0(s2)
    800062dc:	4711                	li	a4,4
    800062de:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062e0:	00093703          	ld	a4,0(s2)
    800062e4:	4785                	li	a5,1
    800062e6:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062ea:	00093703          	ld	a4,0(s2)
    800062ee:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062f2:	00093783          	ld	a5,0(s2)
    800062f6:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    800062fa:	00019517          	auipc	a0,0x19
    800062fe:	02650513          	addi	a0,a0,38 # 8001f320 <lock>
    80006302:	00001097          	auipc	ra,0x1
    80006306:	e44080e7          	jalr	-444(ra) # 80007146 <acquire>
  pos = sockets;
    8000630a:	00004597          	auipc	a1,0x4
    8000630e:	d1e5b583          	ld	a1,-738(a1) # 8000a028 <sockets>
  while (pos) {
    80006312:	c9b1                	beqz	a1,80006366 <sockalloc+0xee>
  pos = sockets;
    80006314:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    80006316:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    8000631a:	0009869b          	sext.w	a3,s3
    8000631e:	a019                	j	80006324 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    80006320:	639c                	ld	a5,0(a5)
  while (pos) {
    80006322:	c3b1                	beqz	a5,80006366 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80006324:	4798                	lw	a4,8(a5)
    80006326:	fe971de3          	bne	a4,s1,80006320 <sockalloc+0xa8>
    8000632a:	00c7d703          	lhu	a4,12(a5)
    8000632e:	fec719e3          	bne	a4,a2,80006320 <sockalloc+0xa8>
        pos->lport == lport &&
    80006332:	00e7d703          	lhu	a4,14(a5)
    80006336:	fed715e3          	bne	a4,a3,80006320 <sockalloc+0xa8>
      release(&lock);
    8000633a:	00019517          	auipc	a0,0x19
    8000633e:	fe650513          	addi	a0,a0,-26 # 8001f320 <lock>
    80006342:	00001097          	auipc	ra,0x1
    80006346:	eb8080e7          	jalr	-328(ra) # 800071fa <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    8000634a:	8556                	mv	a0,s5
    8000634c:	ffffa097          	auipc	ra,0xffffa
    80006350:	cd0080e7          	jalr	-816(ra) # 8000001c <kfree>
  if (*f)
    80006354:	00093503          	ld	a0,0(s2)
    80006358:	c129                	beqz	a0,8000639a <sockalloc+0x122>
    fileclose(*f);
    8000635a:	ffffd097          	auipc	ra,0xffffd
    8000635e:	66e080e7          	jalr	1646(ra) # 800039c8 <fileclose>
  return -1;
    80006362:	557d                	li	a0,-1
    80006364:	a005                	j	80006384 <sockalloc+0x10c>
  si->next = sockets;
    80006366:	00bab023          	sd	a1,0(s5)
  sockets = si;
    8000636a:	00004797          	auipc	a5,0x4
    8000636e:	cb57bf23          	sd	s5,-834(a5) # 8000a028 <sockets>
  release(&lock);
    80006372:	00019517          	auipc	a0,0x19
    80006376:	fae50513          	addi	a0,a0,-82 # 8001f320 <lock>
    8000637a:	00001097          	auipc	ra,0x1
    8000637e:	e80080e7          	jalr	-384(ra) # 800071fa <release>
  return 0;
    80006382:	4501                	li	a0,0
}
    80006384:	70e2                	ld	ra,56(sp)
    80006386:	7442                	ld	s0,48(sp)
    80006388:	74a2                	ld	s1,40(sp)
    8000638a:	7902                	ld	s2,32(sp)
    8000638c:	69e2                	ld	s3,24(sp)
    8000638e:	6a42                	ld	s4,16(sp)
    80006390:	6aa2                	ld	s5,8(sp)
    80006392:	6121                	addi	sp,sp,64
    80006394:	8082                	ret
  return -1;
    80006396:	557d                	li	a0,-1
    80006398:	b7f5                	j	80006384 <sockalloc+0x10c>
    8000639a:	557d                	li	a0,-1
    8000639c:	b7e5                	j	80006384 <sockalloc+0x10c>

000000008000639e <sockclose>:
...
sockclose(struct sock *si)
{
    ...
    800063aa:	892a                	mv	s2,a0
  struct sock **pos;
  struct mbuf *m;

  // remove from list of sockets
  acquire(&lock);
    800063ac:	00019517          	auipc	a0,0x19
    800063b0:	f7450513          	addi	a0,a0,-140 # 8001f320 <lock>
    800063b4:	00001097          	auipc	ra,0x1
    800063b8:	d92080e7          	jalr	-622(ra) # 80007146 <acquire>
  pos = &sockets;
    800063bc:	00004797          	auipc	a5,0x4
    800063c0:	c6c7b783          	ld	a5,-916(a5) # 8000a028 <sockets>
  while (*pos) {
    800063c4:	cb99                	beqz	a5,800063da <sockclose+0x3c>
    if (*pos == si){
    800063c6:	02f90563          	beq	s2,a5,800063f0 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063ca:	873e                	mv	a4,a5
    800063cc:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063ce:	c791                	beqz	a5,800063da <sockclose+0x3c>
    if (*pos == si){
    800063d0:	fef91de3          	bne	s2,a5,800063ca <sockclose+0x2c>
      *pos = si->next;
    800063d4:	00093783          	ld	a5,0(s2)
    800063d8:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063da:	00019517          	auipc	a0,0x19
    800063de:	f4650513          	addi	a0,a0,-186 # 8001f320 <lock>
    800063e2:	00001097          	auipc	ra,0x1
    800063e6:	e18080e7          	jalr	-488(ra) # 800071fa <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063ea:	02890493          	addi	s1,s2,40
    800063ee:	a839                	j	8000640c <sockclose+0x6e>
  pos = &sockets;
    800063f0:	00004717          	auipc	a4,0x4
    800063f4:	c3870713          	addi	a4,a4,-968 # 8000a028 <sockets>
    800063f8:	bff1                	j	800063d4 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063fa:	8526                	mv	a0,s1
    800063fc:	00000097          	auipc	ra,0x0
    80006400:	926080e7          	jalr	-1754(ra) # 80005d22 <mbufq_pophead>
    mbuffree(m);
    80006404:	00000097          	auipc	ra,0x0
    80006408:	8e6080e7          	jalr	-1818(ra) # 80005cea <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    8000640c:	8526                	mv	a0,s1
    8000640e:	00000097          	auipc	ra,0x0
    80006412:	92a080e7          	jalr	-1750(ra) # 80005d38 <mbufq_empty>
    80006416:	d175                	beqz	a0,800063fa <sockclose+0x5c>
  }

  kfree((char*)si);
    80006418:	854a                	mv	a0,s2
    8000641a:	ffffa097          	auipc	ra,0xffffa
    8000641e:	c02080e7          	jalr	-1022(ra) # 8000001c <kfree>
}
    80006422:	60e2                	ld	ra,24(sp)
    80006424:	6442                	ld	s0,16(sp)
    80006426:	64a2                	ld	s1,8(sp)
    80006428:	6902                	ld	s2,0(sp)
    8000642a:	6105                	addi	sp,sp,32
    8000642c:	8082                	ret

000000008000642e <sockread>:
...
sockread(struct sock *si, uint64 addr, int n)
{
    ...
    80006442:	8a2e                	mv	s4,a1
    80006444:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006446:	ffffb097          	auipc	ra,0xffffb
    8000644a:	a7c080e7          	jalr	-1412(ra) # 80000ec2 <myproc>
    8000644e:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006450:	01048993          	addi	s3,s1,16
    80006454:	854e                	mv	a0,s3
    80006456:	00001097          	auipc	ra,0x1
    8000645a:	cf0080e7          	jalr	-784(ra) # 80007146 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    8000645e:	02848493          	addi	s1,s1,40
    80006462:	8526                	mv	a0,s1
    80006464:	00000097          	auipc	ra,0x0
    80006468:	8d4080e7          	jalr	-1836(ra) # 80005d38 <mbufq_empty>
    8000646c:	c919                	beqz	a0,80006482 <sockread+0x54>
    8000646e:	03092783          	lw	a5,48(s2)
    80006472:	eba5                	bnez	a5,800064e2 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006474:	85ce                	mv	a1,s3
    80006476:	8526                	mv	a0,s1
    80006478:	ffffb097          	auipc	ra,0xffffb
    8000647c:	25a080e7          	jalr	602(ra) # 800016d2 <sleep>
    80006480:	b7cd                	j	80006462 <sockread+0x34>
  }
  if (pr->killed) {
    80006482:	03092783          	lw	a5,48(s2)
    80006486:	efb1                	bnez	a5,800064e2 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    8000648e:	898080e7          	jalr	-1896(ra) # 80005d22 <mbufq_pophead>
    80006492:	84aa                	mv	s1,a0
  release(&si->lock);
    80006494:	854e                	mv	a0,s3
    80006496:	00001097          	auipc	ra,0x1
    8000649a:	d64080e7          	jalr	-668(ra) # 800071fa <release>

  len = m->len;
    8000649e:	489c                	lw	a5,16(s1)
  if (len > n)
    800064a0:	89be                	mv	s3,a5
    800064a2:	00fad363          	bge	s5,a5,800064a8 <sockread+0x7a>
    800064a6:	89d6                	mv	s3,s5
    800064a8:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    800064aa:	86ce                	mv	a3,s3
    800064ac:	6490                	ld	a2,8(s1)
    800064ae:	85d2                	mv	a1,s4
    800064b0:	05093503          	ld	a0,80(s2)
    800064b4:	ffffa097          	auipc	ra,0xffffa
    800064b8:	6a4080e7          	jalr	1700(ra) # 80000b58 <copyout>
    800064bc:	892a                	mv	s2,a0
    800064be:	57fd                	li	a5,-1
    800064c0:	02f50863          	beq	a0,a5,800064f0 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064ca:	824080e7          	jalr	-2012(ra) # 80005cea <mbuffree>
  return len;
}
    ...
    800064e0:	8082                	ret
    release(&si->lock);
    800064e2:	854e                	mv	a0,s3
    800064e4:	00001097          	auipc	ra,0x1
    800064e8:	d16080e7          	jalr	-746(ra) # 800071fa <release>
    return -1;
    800064ec:	59fd                	li	s3,-1
    800064ee:	b7c5                	j	800064ce <sockread+0xa0>
    mbuffree(m);
    800064f0:	8526                	mv	a0,s1
    800064f2:	fffff097          	auipc	ra,0xfffff
    800064f6:	7f8080e7          	jalr	2040(ra) # 80005cea <mbuffree>
    return -1;
    800064fa:	89ca                	mv	s3,s2
    800064fc:	bfc9                	j	800064ce <sockread+0xa0>

00000000800064fe <sockwrite>:
...
sockwrite(struct sock *si, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    8000651a:	9ac080e7          	jalr	-1620(ra) # 80000ec2 <myproc>
    8000651e:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006520:	08000513          	li	a0,128
    80006524:	fffff097          	auipc	ra,0xfffff
    80006528:	76e080e7          	jalr	1902(ra) # 80005c92 <mbufalloc>
  if (!m)
    8000652c:	c12d                	beqz	a0,8000658e <sockwrite+0x90>
    8000652e:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    80006530:	050a3a03          	ld	s4,80(s4)
    80006534:	85ca                	mv	a1,s2
    80006536:	fffff097          	auipc	ra,0xfffff
    8000653a:	700080e7          	jalr	1792(ra) # 80005c36 <mbufput>
    8000653e:	85aa                	mv	a1,a0
    80006540:	86ca                	mv	a3,s2
    80006542:	864e                	mv	a2,s3
    80006544:	8552                	mv	a0,s4
    80006546:	ffffa097          	auipc	ra,0xffffa
    8000654a:	69e080e7          	jalr	1694(ra) # 80000be4 <copyin>
    8000654e:	89aa                	mv	s3,a0
    80006550:	57fd                	li	a5,-1
    80006552:	02f50863          	beq	a0,a5,80006582 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006556:	00ead683          	lhu	a3,14(s5)
    8000655a:	00cad603          	lhu	a2,12(s5)
    8000655e:	008aa583          	lw	a1,8(s5)
    80006562:	8526                	mv	a0,s1
    80006564:	fffff097          	auipc	ra,0xfffff
    80006568:	7f6080e7          	jalr	2038(ra) # 80005d5a <net_tx_udp>
  return n;
    8000656c:	89ca                	mv	s3,s2
}
    8000656e:	854e                	mv	a0,s3
    80006570:	70e2                	ld	ra,56(sp)
    80006572:	7442                	ld	s0,48(sp)
    80006574:	74a2                	ld	s1,40(sp)
    80006576:	7902                	ld	s2,32(sp)
    80006578:	69e2                	ld	s3,24(sp)
    8000657a:	6a42                	ld	s4,16(sp)
    8000657c:	6aa2                	ld	s5,8(sp)
    8000657e:	6121                	addi	sp,sp,64
    80006580:	8082                	ret
    mbuffree(m);
    80006582:	8526                	mv	a0,s1
    80006584:	fffff097          	auipc	ra,0xfffff
    80006588:	766080e7          	jalr	1894(ra) # 80005cea <mbuffree>
    return -1;
    8000658c:	b7cd                	j	8000656e <sockwrite+0x70>
    return -1;
    8000658e:	59fd                	li	s3,-1
    80006590:	bff9                	j	8000656e <sockwrite+0x70>

0000000080006592 <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    80006592:	7139                	addi	sp,sp,-64
    80006594:	fc06                	sd	ra,56(sp)
    80006596:	f822                	sd	s0,48(sp)
    80006598:	f426                	sd	s1,40(sp)
    8000659a:	f04a                	sd	s2,32(sp)
    8000659c:	ec4e                	sd	s3,24(sp)
    8000659e:	e852                	sd	s4,16(sp)
    800065a0:	e456                	sd	s5,8(sp)
    800065a2:	0080                	addi	s0,sp,64
    800065a4:	8a2a                	mv	s4,a0
    800065a6:	892e                	mv	s2,a1
    800065a8:	89b2                	mv	s3,a2
    800065aa:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    800065ac:	00019517          	auipc	a0,0x19
    800065b0:	d7450513          	addi	a0,a0,-652 # 8001f320 <lock>
    800065b4:	00001097          	auipc	ra,0x1
    800065b8:	b92080e7          	jalr	-1134(ra) # 80007146 <acquire>
  si = sockets;
    800065bc:	00004497          	auipc	s1,0x4
    800065c0:	a6c4b483          	ld	s1,-1428(s1) # 8000a028 <sockets>
  while (si) {
    800065c4:	c4ad                	beqz	s1,8000662e <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065c6:	0009871b          	sext.w	a4,s3
    800065ca:	000a869b          	sext.w	a3,s5
    800065ce:	a019                	j	800065d4 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065d0:	6084                	ld	s1,0(s1)
  while (si) {
    800065d2:	ccb1                	beqz	s1,8000662e <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065d4:	449c                	lw	a5,8(s1)
    800065d6:	ff279de3          	bne	a5,s2,800065d0 <sockrecvudp+0x3e>
    800065da:	00c4d783          	lhu	a5,12(s1)
    800065de:	fee799e3          	bne	a5,a4,800065d0 <sockrecvudp+0x3e>
    800065e2:	00e4d783          	lhu	a5,14(s1)
    800065e6:	fed795e3          	bne	a5,a3,800065d0 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065ea:	01048913          	addi	s2,s1,16
    800065ee:	854a                	mv	a0,s2
    800065f0:	00001097          	auipc	ra,0x1
    800065f4:	b56080e7          	jalr	-1194(ra) # 80007146 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065f8:	02848493          	addi	s1,s1,40
    800065fc:	85d2                	mv	a1,s4
    800065fe:	8526                	mv	a0,s1
    80006600:	fffff097          	auipc	ra,0xfffff
    80006604:	702080e7          	jalr	1794(ra) # 80005d02 <mbufq_pushtail>
  wakeup(&si->rxq);
    80006608:	8526                	mv	a0,s1
    8000660a:	ffffb097          	auipc	ra,0xffffb
    8000660e:	24e080e7          	jalr	590(ra) # 80001858 <wakeup>
  release(&si->lock);
    80006612:	854a                	mv	a0,s2
    80006614:	00001097          	auipc	ra,0x1
    80006618:	be6080e7          	jalr	-1050(ra) # 800071fa <release>
  release(&lock);
    8000661c:	00019517          	auipc	a0,0x19
    80006620:	d0450513          	addi	a0,a0,-764 # 8001f320 <lock>
    80006624:	00001097          	auipc	ra,0x1
    80006628:	bd6080e7          	jalr	-1066(ra) # 800071fa <release>
    8000662c:	a831                	j	80006648 <sockrecvudp+0xb6>
  release(&lock);
    8000662e:	00019517          	auipc	a0,0x19
    80006632:	cf250513          	addi	a0,a0,-782 # 8001f320 <lock>
    80006636:	00001097          	auipc	ra,0x1
    8000663a:	bc4080e7          	jalr	-1084(ra) # 800071fa <release>
  mbuffree(m);
    8000663e:	8552                	mv	a0,s4
    80006640:	fffff097          	auipc	ra,0xfffff
    80006644:	6aa080e7          	jalr	1706(ra) # 80005cea <mbuffree>
}
...
pci_init()
{
    8000665a:	715d                	addi	sp,sp,-80
    8000665c:	e486                	sd	ra,72(sp)
    8000665e:	e0a2                	sd	s0,64(sp)
    80006660:	fc26                	sd	s1,56(sp)
    80006662:	f84a                	sd	s2,48(sp)
    80006664:	f44e                	sd	s3,40(sp)
    80006666:	f052                	sd	s4,32(sp)
    80006668:	ec56                	sd	s5,24(sp)
    8000666a:	e85a                	sd	s6,16(sp)
    8000666c:	e45e                	sd	s7,8(sp)
    8000666e:	0880                	addi	s0,sp,80
    80006670:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006674:	100e8937          	lui	s2,0x100e8
    80006678:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000667c:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    8000667e:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006680:	40000b37          	lui	s6,0x40000
    80006684:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006686:	300409b7          	lui	s3,0x30040
    8000668a:	a821                	j	800066a2 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000668c:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006690:	40000537          	lui	a0,0x40000
    80006694:	fffff097          	auipc	ra,0xfffff
    80006698:	0fc080e7          	jalr	252(ra) # 80005790 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    8000669c:	94d2                	add	s1,s1,s4
    8000669e:	03348a63          	beq	s1,s3,800066d2 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    800066a2:	86a6                	mv	a3,s1
    uint32 id = base[0];
    800066a4:	409c                	lw	a5,0(s1)
    800066a6:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    800066a8:	ff279ae3          	bne	a5,s2,8000669c <pci_init+0x42>
      base[1] = 7;
    800066ac:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    800066b0:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066b4:	01048793          	addi	a5,s1,16
    800066b8:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066bc:	4398                	lw	a4,0(a5)
    800066be:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066c0:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066c4:	0ff0000f          	fence
        base[4+i] = old;
    800066c8:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066ca:	0791                	addi	a5,a5,4
    800066cc:	fec798e3          	bne	a5,a2,800066bc <pci_init+0x62>
    800066d0:	bf75                	j	8000668c <pci_init+0x32>
    }
  }
}
    800066d2:	60a6                	ld	ra,72(sp)
    800066d4:	6406                	ld	s0,64(sp)
    800066d6:	74e2                	ld	s1,56(sp)
    800066d8:	7942                	ld	s2,48(sp)
    800066da:	79a2                	ld	s3,40(sp)
    800066dc:	7a02                	ld	s4,32(sp)
    800066de:	6ae2                	ld	s5,24(sp)
    800066e0:	6b42                	ld	s6,16(sp)
    800066e2:	6ba2                	ld	s7,8(sp)
    800066e4:	6161                	addi	sp,sp,80
    800066e6:	8082                	ret

00000000800066e8 <timerinit>:
...
timerinit()
{
    ...
    800066ea:	e422                	sd	s0,8(sp)
    800066ec:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066ee:	f14027f3          	csrr	a5,mhartid
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066f6:	0037979b          	slliw	a5,a5,0x3
    800066fa:	02004737          	lui	a4,0x2004
    800066fe:	97ba                	add	a5,a5,a4
    80006700:	0200c737          	lui	a4,0x200c
    80006704:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    80006708:	000f4637          	lui	a2,0xf4
    8000670c:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    80006710:	95b2                	add	a1,a1,a2
    80006712:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    80006714:	00269713          	slli	a4,a3,0x2
    80006718:	9736                	add	a4,a4,a3
    8000671a:	00371693          	slli	a3,a4,0x3
    8000671e:	00019717          	auipc	a4,0x19
    80006722:	c2270713          	addi	a4,a4,-990 # 8001f340 <timer_scratch>
    80006726:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    80006728:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    8000672a:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    8000672c:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    80006730:	fffff797          	auipc	a5,0xfffff
    80006734:	a0078793          	addi	a5,a5,-1536 # 80005130 <timervec>
    80006738:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    8000673c:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    80006740:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006744:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    80006748:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    8000674c:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    80006750:	30479073          	csrw	mie,a5
}
    80006754:	6422                	ld	s0,8(sp)
    80006756:	0141                	addi	sp,sp,16
    80006758:	8082                	ret

000000008000675a <start>:
{
    8000675a:	1141                	addi	sp,sp,-16
    8000675c:	e406                	sd	ra,8(sp)
    8000675e:	e022                	sd	s0,0(sp)
    80006760:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006762:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006766:	7779                	lui	a4,0xffffe
    80006768:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000676c:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    8000676e:	6705                	lui	a4,0x1
    80006770:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006774:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006776:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    8000677a:	ffffa797          	auipc	a5,0xffffa
    8000677e:	bb078793          	addi	a5,a5,-1104 # 8000032a <main>
    80006782:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006786:	4781                	li	a5,0
    80006788:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000678c:	67c1                	lui	a5,0x10
    8000678e:	17fd                	addi	a5,a5,-1
    80006790:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006794:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    80006798:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    8000679c:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    800067a0:	10479073          	csrw	sie,a5
  timerinit();
    800067a4:	00000097          	auipc	ra,0x0
    800067a8:	f44080e7          	jalr	-188(ra) # 800066e8 <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    800067ee:	1a0080e7          	jalr	416(ra) # 8000198a <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  while(n > 0){
    ...
    80006886:	640080e7          	jalr	1600(ra) # 80000ec2 <myproc>
    8000688a:	591c                	lw	a5,48(a0)
    ...
    80006896:	e40080e7          	jalr	-448(ra) # 800016d2 <sleep>
    while(cons.r == cons.w){
    ...
    800068d2:	066080e7          	jalr	102(ra) # 80001934 <either_copyout>
...
consoleintr(int c)
{
  ...
  case C('P'):  // Print process list.
    ...
    800069b4:	030080e7          	jalr	48(ra) # 800019e0 <procdump>
      }
    }
    break;
  }
  ...
  switch(c){
    ...
    80006b08:	d54080e7          	jalr	-684(ra) # 80001858 <wakeup>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80006b1a:	cea58593          	addi	a1,a1,-790 # 80009800 <syscalls+0x450>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80006b3a:	59a78793          	addi	a5,a5,1434 # 8001a0d0 <devsw>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    80006b7c:	cb860613          	addi	a2,a2,-840 # 80009830 <digits>
...
panic(char *s)
{
  ...
  printf("panic: ");
    ...
    80006c14:	bf850513          	addi	a0,a0,-1032 # 80009808 <syscalls+0x458>
...
0000000080006c46 <printf>:
{
  ...
  consputc('x');
    ...
    80006ca8:	b8cb8b93          	addi	s7,s7,-1140 # 80009830 <digits>
    switch(c){
    ...
    80006ccc:	b5050513          	addi	a0,a0,-1200 # 80009818 <syscalls+0x468>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80006dcc:	a4890913          	addi	s2,s2,-1464 # 80009810 <syscalls+0x460>
      for(; *s; s++)
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80006e42:	9ea58593          	addi	a1,a1,-1558 # 80009828 <syscalls+0x478>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80006e92:	9ba58593          	addi	a1,a1,-1606 # 80009848 <digits+0x18>
    ...
    80006f0e:	06e78c63          	beq	a5,a4,80006f86 <uartstart+0x88>
{
    ...
    80006f62:	8fa080e7          	jalr	-1798(ra) # 80001858 <wakeup>
...
0000000080006f88 <uartputc>:
{
  ...
  if(panicked){
    ...
    80006fee:	6e8080e7          	jalr	1768(ra) # 800016d2 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    ...
    800070d2:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    ...
    800070e4:	dc6080e7          	jalr	-570(ra) # 80000ea6 <mycpu>
...
push_off(void)
{
  ...
  if(mycpu()->noff == 0)
    ...
    80007116:	d94080e7          	jalr	-620(ra) # 80000ea6 <mycpu>
  ...
  mycpu()->noff += 1;
    ...
    8000713a:	d70080e7          	jalr	-656(ra) # 80000ea6 <mycpu>
  return (x & SSTATUS_SIE) != 0;
...
0000000080007146 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    8000717a:	d30080e7          	jalr	-720(ra) # 80000ea6 <mycpu>
    ...
    8000718e:	6c650513          	addi	a0,a0,1734 # 80009850 <digits+0x20>
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    800071a6:	d04080e7          	jalr	-764(ra) # 80000ea6 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800071de:	67e50513          	addi	a0,a0,1662 # 80009858 <digits+0x28>
    800071e2:	00000097          	auipc	ra,0x0
    800071e6:	a1a080e7          	jalr	-1510(ra) # 80006bfc <panic>
    panic("pop_off");
    800071ea:	00002517          	auipc	a0,0x2
    800071ee:	68650513          	addi	a0,a0,1670 # 80009870 <digits+0x40>
...
00000000800071fa <release>:
{
  ...
  pop_off();
    ...
    80007236:	64650513          	addi	a0,a0,1606 # 80009878 <digits+0x48>
