...
main(int argc, char *argv[])
{
   ...
   8:	1000                	addi	s0,sp,32
    ...
    if (argc != 2)
   a:	4789                	li	a5,2
   c:	02f50a63          	beq	a0,a5,40 <main+0x40>
  ...
  14:	80850513          	addi	a0,a0,-2040 # 818 <malloc+0xe6>
  18:	00000097          	auipc	ra,0x0
  1c:	0b6080e7          	jalr	182(ra) # ce <strlen>
  20:	0005061b          	sext.w	a2,a0
  24:	00000597          	auipc	a1,0x0
  28:	7f458593          	addi	a1,a1,2036 # 818 <malloc+0xe6>
  2c:	4509                	li	a0,2
  2e:	00000097          	auipc	ra,0x0
  32:	2ee080e7          	jalr	750(ra) # 31c <write>
        // 也可以使用 user/printf.c 中的 fprintf(int fd, const char *fmt, ...) 函数进行格式化输出
        // fprintf(2, "Usage: sleep time\n");
        // 退出程序,返回值非0表示错误
        exit(1);
  36:	4505                	li	a0,1
  38:	00000097          	auipc	ra,0x0
  3c:	2c4080e7          	jalr	708(ra) # 2fc <exit>
    }
    // 把字符串型参数转换为整型
    int time = atoi(argv[1]);
  40:	6588                	ld	a0,8(a1)
  42:	00000097          	auipc	ra,0x0
  46:	1ba080e7          	jalr	442(ra) # 1fc <atoi>
  4a:	84aa                	mv	s1,a0
    // 调用系统调用 sleep，传入整型参数
    write(2, "sleeping...\n", strlen("sleeping...\n"));
  4c:	00000517          	auipc	a0,0x0
  50:	7e450513          	addi	a0,a0,2020 # 830 <malloc+0xfe>
  54:	00000097          	auipc	ra,0x0
  58:	07a080e7          	jalr	122(ra) # ce <strlen>
  5c:	0005061b          	sext.w	a2,a0
  60:	00000597          	auipc	a1,0x0
  64:	7d058593          	addi	a1,a1,2000 # 830 <malloc+0xfe>
  68:	4509                	li	a0,2
  6a:	00000097          	auipc	ra,0x0
  6e:	2b2080e7          	jalr	690(ra) # 31c <write>
    sleep(time);
  72:	8526                	mv	a0,s1
  74:	00000097          	auipc	ra,0x0
  78:	318080e7          	jalr	792(ra) # 38c <sleep>
    // 正常退出程序，返回值0
    exit(0);
  7c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e4:	46850513          	addi	a0,a0,1128 # 848 <digits>
 3e8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f0:	25490913          	addi	s2,s2,596 # 840 <malloc+0x10e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b8:	1ac7b783          	ld	a5,428(a5) # 860 <freep>
 ...
 6e6:	00e6ea63          	bltu	a3,a4,6fa <free+0x50>
{
 ...
 728:	12f73e23          	sd	a5,316(a4) # 860 <freep>
}
 72c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75a:	10a53503          	ld	a0,266(a0) # 860 <freep>
 ...
 782:	0e290913          	addi	s2,s2,226 # 860 <freep>
  if(p == (char*)-1)
 786:	5afd                	li	s5,-1
 788:	a88d                	j	7fa <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 78a:	00000797          	auipc	a5,0x0
 78e:	0de78793          	addi	a5,a5,222 # 868 <base>
 792:	00000717          	auipc	a4,0x0
 796:	0cf73723          	sd	a5,206(a4) # 860 <freep>
 79a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7bc:	0aa73423          	sd	a0,168(a4) # 860 <freep>
      return (void*)(p + 1);
